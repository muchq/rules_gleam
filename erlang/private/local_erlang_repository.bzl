...
def _local_erlang_repository_impl(repository_ctx):
    ...
    build_content = """\
load("@com_muchq_rules_gleam//erlang/private:erlang_toolchain_config.bzl", "erlang_toolchain_config")
load("@com_muchq_rules_gleam//erlang/private:erlang_toolchain.bzl", "erlang_toolchain")
...
toolchain(
    ...
    toolchain_type = "@com_muchq_rules_gleam//erlang:erlang_toolchain_type",
