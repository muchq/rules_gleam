...
from the repository with gleam_toolchain targets.
...
# By default all these toolchains are registered by the gleam_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:gleam_toolchain",
    toolchain_type = "@com_muchq_rules_gleam//gleam:toolchain_type",
)
""".format(
            platform = platform,
